...
func (_q *EventQuery) QuerySubmission() *SubmissionQuery {
...
func (_q *EventQuery) WithSubmission(opts ...func(*SubmissionQuery)) *EventQuery {
	query := (&SubmissionClient{config: _q.config}).Query()
...
func (_q *EventQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Event, error) {
	...
	if query := _q.withSubmission; query != nil {
		if err := _q.loadSubmission(ctx, query, nodes, nil,
			func(n *Event, e *Submission) { n.Edges.Submission = e }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *EventQuery) loadSubmission(ctx context.Context, query *SubmissionQuery, nodes []*Event, init func(*Event), assign func(*Event, *Submission)) error {
...
func (_q *EventQuery) querySpec() *sqlgraph.QuerySpec {
	...
	if fields := _q.ctx.Fields; len(fields) > 0 {
		...
		if _q.withSubmission != nil {
			_spec.Node.AddColumnOnce(event.FieldSubmissionID)
		}
	}
