...
// The SubmitterFunc type is an adapter to allow the use of ordinary
// function as Submitter mutator.
type SubmitterFunc func(context.Context, *ent.SubmitterMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f SubmitterFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.SubmitterMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.SubmitterMutation", m)
}
...
// The TemplateFolderFunc type is an adapter to allow the use of ordinary
// function as TemplateFolder mutator.
type TemplateFolderFunc func(context.Context, *ent.TemplateFolderMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f TemplateFolderFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.TemplateFolderMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.TemplateFolderMutation", m)
}
