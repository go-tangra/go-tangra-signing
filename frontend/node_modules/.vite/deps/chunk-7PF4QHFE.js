import {
  init_esm,
  setupDevtoolsPlugin
} from "./chunk-OAD73IJ7.js";
import {
  require_signing_loadShare_vue_loadShare
} from "./chunk-PK6HZN7Z.js";
import {
  __esm,
  __toESM
...
var import_vue, isBrowser, assign, noop, isArray, HASH_RE, AMPERSAND_RE, SLASH_RE, EQUAL_RE, IM_RE, PLUS_RE, ENC_BRACKET_OPEN_RE, ENC_BRACKET_CLOSE_RE, ENC_CARET_RE, ENC_BACKTICK_RE, ENC_CURLY_OPEN_RE, ENC_PIPE_RE, ENC_CURLY_CLOSE_RE, ENC_SPACE_RE, TRAILING_SLASH_RE, removeTrailingSlash, START_LOCATION_NORMALIZED, NavigationType, NavigationDirection, START, BEFORE_HASH_RE, computeScrollPosition, scrollPositions, ErrorTypes, NavigationFailureSymbol, NavigationFailureType, ErrorTypeMessages, propertiesToLog, matchedRouteKey, viewDepthKey, routerKey, routeLocationKey, routerViewLocationKey, routerId, PINK_500, BLUE_600, LIME_500, CYAN_400, ORANGE_400, DARK, RED_100, RED_700, routeRecordId, EXTRACT_REGEXP_RE;
var init_devtools_EWN81iOl = __esm({
  "node_modules/.pnpm/vue-router@4.6.4_vue@3.5.30_typescript@5.9.3_/node_modules/vue-router/dist/devtools-EWN81iOl.mjs"() {
    import_vue = __toESM(require_signing_loadShare_vue_loadShare(), 1);
    init_esm();
    ...
    NavigationType = (function(NavigationType$1) {
      NavigationType$1["pop"] = "pop";
      NavigationType$1["push"] = "push";
      return NavigationType$1;
    })({});
    NavigationDirection = (function(NavigationDirection$1) {
    ...
    ErrorTypes = (function(ErrorTypes$1) {
    ...
    NavigationFailureSymbol = Symbol(true ? "navigation failure" : "");
    NavigationFailureType = (function(NavigationFailureType$1) {
 ...
 ${JSON.stringify(location2)}${currentLocation ? "\nwhile being at\n" + JSON.stringify(currentLocation) : ""}`;
    ...
    matchedRouteKey = Symbol(true ? "router view location matched" : "");
    viewDepthKey = Symbol(true ? "router view depth" : "");
    routerKey = Symbol(true ? "router" : "");
    routeLocationKey = Symbol(true ? "route location" : "");
    routerViewLocationKey = Symbol(true ? "router view location" : "");
    routerId = 0;
    PINK_500 = 15485081;
    BLUE_600 = 2450411;
    LIME_500 = 8702998;
...
function useLink(props) {
  const router = (0, import_vue2.inject)(routerKey);
  const currentRoute = (0, import_vue2.inject)(routeLocationKey);
  let hasPrevious = false;
  let previousTo = null;
  const route = (0, import_vue2.computed)(() => {
    const to = (0, import_vue2.unref)(props.to);
...
- props:`, props);
  ...
  const activeRecordIndex = (0, import_vue2.computed)(() => {
  ...
  const isActive = (0, import_vue2.computed)(() => activeRecordIndex.value > -1 && includesParams(currentRoute.params, route.value.params));
  const isExactActive = (0, import_vue2.computed)(() => activeRecordIndex.value > -1 && activeRecordIndex.value === currentRoute.matched.length - 1 && isSameRouteLocationParams(currentRoute.params, route.value.params));
  function navigate(e = {}) {
    if (guardEvent(e)) {
      const p = router[(0, import_vue2.unref)(props.replace) ? "replace" : "push"]((0, import_vue2.unref)(props.to)).catch(noop);
  ...
  if (isBrowser) {
    ...
    if (instance) {
      ...
      (0, import_vue2.watchEffect)(() => {
        ...
        linkContextDevtools.error = isRouteLocation((0, import_vue2.unref)(props.to)) ? null : 'Invalid "to" value';
      }, { flush: "post" });
    }
  }
  return {
    route,
    href: (0, import_vue2.computed)(() => route.value.href),
    isActive,
    isExactActive,
    navigate
  };
...
function createRouter(options) {
  ...
  const currentRoute = (0, import_vue2.shallowRef)(START_LOCATION_NORMALIZED);
...
${JSON.stringify(newTargetLocation, null, 2)}
 ...
 Are you always returning a new location within a navigation guard? That would lead to this error. Only return when redirecting or aborting, that should fix this. This might break in production if not fixed.`);
  ...
  function handleScroll(to, from, isPush, isFirstNavigation) {
    ...
    return (0, import_vue2.nextTick)().then(() => scrollBehavior(to, from, scrollPosition)).then((position) => position && scrollToPosition(position)).catch((err) => triggerError(err, to, from));
  }
  ...
  const router = {
    ...
    install(app) {
      ...
      Object.defineProperty(app.config.globalProperties, "$route", {
        enumerable: true,
        get: () => (0, import_vue2.unref)(currentRoute)
      });
      ...
      app.provide(routeLocationKey, (0, import_vue2.shallowReactive)(reactiveRoute));
...
function useRouter() {
  return (0, import_vue2.inject)(routerKey);
}
function useRoute(_name) {
  return (0, import_vue2.inject)(routeLocationKey);
}
var import_vue2, createBaseLocation, TokenType, TokenizerState, ROOT_TOKEN, VALID_PARAM_RE, BASE_PARAM_PATTERN, BASE_PATH_PARSER_OPTIONS, PathScore, REGEX_CHARS_RE, PATH_PARSER_OPTIONS_DEFAULTS, RouterLinkImpl, RouterLink, getLinkClass, RouterViewImpl, RouterView;
var init_vue_router = __esm({
  "node_modules/.pnpm/vue-router@4.6.4_vue@3.5.30_typescript@5.9.3_/node_modules/vue-router/dist/vue-router.mjs"() {
    init_devtools_EWN81iOl();
    import_vue2 = __toESM(require_signing_loadShare_vue_loadShare(), 1);
    createBaseLocation = () => location.protocol + "//" + location.host;
    TokenType = (function(TokenType$1) {
      TokenType$1[TokenType$1["Static"] = 0] = "Static";
      TokenType$1[TokenType$1["Param"] = 1] = "Param";
      TokenType$1[TokenType$1["Group"] = 2] = "Group";
      return TokenType$1;
    })({});
    TokenizerState = (function(TokenizerState$1) {
    ...
    PathScore = (function(PathScore$1) {
    ...
    RouterLinkImpl = (0, import_vue2.defineComponent)({
      name: "RouterLink",
      compatConfig: { MODE: 3 },
      props: {
        to: {
      ...
      useLink,
      setup(props, { slots }) {
        const link = (0, import_vue2.reactive)(useLink(props));
        const { options } = (0, import_vue2.inject)(routerKey);
        const elClass = (0, import_vue2.computed)(() => ({
          [getLinkClass(props.activeClass, options.linkActiveClass, "router-link-active")]: link.isActive,
          [getLinkClass(props.exactActiveClass, options.linkExactActiveClass, "router-link-exact-active")]: link.isExactActive
        }));
        return () => {
          const children = slots.default && preferSingleVNode(slots.default(link));
          return props.custom ? children : (0, import_vue2.h)("a", {
    ...
    RouterViewImpl = (0, import_vue2.defineComponent)({
      name: "RouterView",
      inheritAttrs: false,
      props: {
        name: {
      ...
      setup(props, { attrs, slots }) {
        warnDeprecatedUsage();
        const injectedRoute = (0, import_vue2.inject)(routerViewLocationKey);
        const routeToDisplay = (0, import_vue2.computed)(() => props.route || injectedRoute.value);
        const injectedDepth = (0, import_vue2.inject)(viewDepthKey, 0);
        const depth = (0, import_vue2.computed)(() => {
          let initialDepth = (0, import_vue2.unref)(injectedDepth);
          const { matched } = routeToDisplay.value;
          let matchedRoute;
          while ((matchedRoute = matched[initialDepth]) && !matchedRoute.components) initialDepth++;
          return initialDepth;
        });
        const matchedRouteRef = (0, import_vue2.computed)(() => routeToDisplay.value.matched[depth.value]);
        (0, import_vue2.provide)(viewDepthKey, (0, import_vue2.computed)(() => depth.value + 1));
        (0, import_vue2.provide)(matchedRouteKey, matchedRouteRef);
        (0, import_vue2.provide)(routerViewLocationKey, routeToDisplay);
        const viewRef = (0, import_vue2.ref)();
        (0, import_vue2.watch)(() => [
          viewRef.value,
        ...
        return () => {
          ...
          const component = (0, import_vue2.h)(ViewComponent, assign({}, routeProps, attrs, {
            onVnodeUnmounted,
            ref: viewRef
          }));
...
vue-router/dist/vue-router.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-7PF4QHFE.js.map
